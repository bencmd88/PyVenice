...
MALE_VOICES = [
    "am_adam", "am_echo", "am_fable", "am_marcus", "am_michael",
    "am_onyx", "am_orion", "am_wade"
]
...
class Audio(BaseResource):
    ...
    def create_speech(
        ...
        *,
        ...
        headers = {
            "Accept": self._get_audio_content_type(response_format)
        }
    ...
    def list_voices(self, gender: Optional[Literal["male", "female"]] = None) -> list[str]:
        """
