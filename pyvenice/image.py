...
class GenerateImageRequest(BaseModel):
    ...
    # Optional parameters
    cfg_scale: Optional[float] = Field(None, gt=0, le=20, description="CFG scale parameter")
...
class OpenAIImageRequest(BaseModel):
    ...
    quality: Optional[Literal["auto", "high", "medium", "low", "hd", "standard"]] = "auto"
...
class ImageGeneration(BaseResource):
    ...
    def generate_openai_style(
        ...
        **kwargs
        ...
        response = self.client.post("/images/generations", request.dict(exclude_none=True))
    ...
    async def generate_async(
        ...
        **kwargs
        ...
        response = await self.client.post_async("/image/generate", request.dict(exclude_none=True))
        return ImageGenerationResponse(**response)
