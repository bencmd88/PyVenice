...
class InferenceDetails(BaseModel):
    ...
    completionTokens: Optional[float] = Field(None, description="Completion tokens for LLM")
    ...
    imageDetails: Optional[Dict[str, Any]] = Field(None, description="Image generation details")
