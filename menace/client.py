...
class VeniceClient:
    ...
    def __init__(
        ...
        if not self.api_key:
            raise ValueError("API key required. Set VENICE_API_KEY env var or pass api_key parameter.")
    ...
    async def get_async(self, endpoint: str, params: Optional[Dict[str, Any]] = None) -> Any:
        """Make an async GET request."""
        return await self._request_async("GET", endpoint, params=params)
    
    async def post_async(self, endpoint: str, data: Dict[str, Any], stream: bool = False) -> Any:
...
class BaseResource:
    ...
    def _validate_params(self, params: Dict[str, Any], allowed_params: set) -> Dict[str, Any]:
