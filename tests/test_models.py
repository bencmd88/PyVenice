...
class TestModels:
    ...
    @respx.mock
    def test_list_models_with_type_filter(self, respx_mock, mock_models_response, client):
    ...
    def test_supports_parameter(self, respx_mock, mock_models_response, client):
        ...
        assert models.supports_parameter("qwen-2.5-qwq-32b", "parallel_tool_calls") is True
        ...
        assert models.supports_parameter("venice-uncensored", "parallel_tool_calls") is False
    ...
    @respx.mock
    def test_supports_parameter_unknown_param(self, respx_mock, mock_models_response, client):
    ...
    @respx.mock
    def test_supports_parameter_no_model(self, respx_mock, mock_models_response, client):
...
class TestCompatibilityMapping:
    ...
    @respx.mock
    def test_get_compatibility_mapping(self, respx_mock, mock_compatibility_mapping, client):
    ...
    @respx.mock
    def test_compatibility_mapping_caching(self, respx_mock, mock_compatibility_mapping, client):
