...
def setup_chat_mocks(respx_mock, mock_models_response, mock_compatibility_mapping, mock_chat_response=None, mock_streaming_response=None):
    ...
    if mock_streaming_response:
        respx_mock.post("https://api.venice.ai/api/v1/chat/completions").mock(
            return_value=httpx.Response(200, content=mock_streaming_response, headers={"content-type": "text/event-stream"})
        )
...
class TestChatCompletion:
    ...
    @respx.mock
    def test_create_chat_completion(self, respx_mock, mock_chat_response, mock_compatibility_mapping, mock_models_response, client):
        """Test creating a chat completion."""
        setup_chat_mocks(respx_mock, mock_models_response, mock_compatibility_mapping, mock_chat_response)
    ...
    @respx.mock
    def test_create_chat_completion_with_parameters(self, respx_mock, mock_chat_response, mock_compatibility_mapping, mock_models_response, client):
    ...
    @respx.mock
    def test_create_with_web_search(self, respx_mock, mock_chat_response, mock_compatibility_mapping, mock_models_response, client):
    ...
    @respx.mock
    def test_streaming_chat_completion(self, respx_mock, mock_streaming_response, mock_compatibility_mapping, mock_models_response, client):
        """Test streaming chat completion."""
        setup_chat_mocks(respx_mock, mock_models_response, mock_compatibility_mapping, mock_streaming_response=mock_streaming_response)
    ...
    @pytest.mark.asyncio
    @respx.mock
    async def test_async_chat_completion(self, respx_mock, mock_chat_response, mock_compatibility_mapping, mock_models_response, client):
    ...
    @pytest.mark.asyncio
    @respx.mock
    async def test_async_streaming_chat_completion(self, respx_mock, mock_streaming_response, mock_compatibility_mapping, mock_models_response, client):
...
class TestParameterValidation:
    ...
    @respx.mock
    def test_parallel_tool_calls_validation(self, respx_mock, mock_models_response, client):
        ...
        respx_mock.post("https://api.venice.ai/api/v1/chat/completions").mock(
            return_value=httpx.Response(200, json={
                ...
                "created": 1234567890,
                "model": "venice-uncensored",
                "choices": [{"index": 0, "message": {"role": "assistant", "content": "test"}, "finish_reason": "stop", "logprobs": None}],
        ...
        request = respx_mock.calls[-1].request
        request_body = json.loads(request.content)
        assert "parallel_tool_calls" not in request_body or request_body["parallel_tool_calls"] is None
    
    @respx.mock 
    def test_function_calling_parameters(self, respx_mock, mock_models_response, client):
...
class TestErrorHandling:
    ...
    @respx.mock
    def test_malformed_streaming_response(self, respx_mock, mock_compatibility_mapping, mock_models_response, client):
        ...
        respx_mock.post("https://api.venice.ai/api/v1/chat/completions").mock(
            return_value=httpx.Response(200, content=malformed_stream, headers={"content-type": "text/event-stream"})
        )
