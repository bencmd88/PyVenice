...
class TestEmbeddingsIntegration:
    ...
    def test_real_embeddings_single_string(self, skip_if_no_api_key, integration_api_key):
    ...
    def test_real_embeddings_multiple_strings(self, skip_if_no_api_key, integration_api_key):
    ...
    def test_real_embeddings_with_dimensions(self, skip_if_no_api_key, integration_api_key):
